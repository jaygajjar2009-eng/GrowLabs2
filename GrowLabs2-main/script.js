...
const areas = [
  { name: 'Bhavnagar', businesses: 220 },
  { name: 'Rajkot', businesses: 118 },
  { name: 'Bharuch', businesses: 98 },
  { name: 'Baroda', businesses: 90 },
  { name: 'Surat', businesses: 74 },
  { name: 'Ahemdavad', businesses: 68 }
];
...
const businesses = [
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 214,
    description: 'Live vibes and family-friendly ambiance.',
    featured: true,
    verified: true,
    new: true,
    openNow: true,
    ...
    image: '2016-teapost-store.jpg',
    logo: 'S',
    phone: '+91 90990 11223',
    whatsapp: '+91 90990 11223',
    website: 'https://teapost@bvn.com',
    instagram: '@teapostbvn',
    address: 'Waghavadi road, Bhavnagar',
